...
var message={
     ...
     phoneNull:"请输入手机号码",
     codeNull:"请输入验证码",
     codeSuccessMsg:"感谢参与活动，注意查收红包或现金券奖励"
}
...
var call={
    ...
    getCode:function(){
        ...
        $('#getcode').on('click',function(){
            ...
            $.ajax({
                url: "/weixin/newFeatureActivity/getActivityCode.htm?phoneNumber="+phone,
    ...
    submitData:function(){
        ...
        $('#submit').on('click',function(ev){
            ...
            var data = {"phoneNumber": phone, "code": code, "description":"橙医生3.0上线活动"};
            var goToResister = false;
            $.ajax({
                url: "/weixin/newFeatureActivity/verifyCode.htm",
                data:data,
                type:"POST",
                async: false,
                success: function(msg){
                    if(msg == ''){
                        var data = {"phoneNumber": phone, "code": code, "description":"橙医生3.0上线活动"};
                        $.ajax({
                            url: "/weixin/newFeatureActivity/registerSendCoupon.htm?jd_qrcode_id=3d2de030-158a-4b74-bbb3-c42dcb7ba1fd",
                            data:data,
                            type:"POST",
                            async: false,
                            success: function(msgbak){
                                ...
                                if(json_msg.result != "0"){
                                    ...
                                    var msgAlert = new Yalert({
                                        ...
                                        time:'20000',
                                        leftfn:function(){
                                        	window.location.href = "/weixin/newFeatureActivity/registerSendCouponSuccess.htm";
                                        }
                                    });
                                }
                            },
