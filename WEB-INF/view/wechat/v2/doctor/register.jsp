        ...
        <div class="step-1">
            <div class="grid">
                <p>
                    ...
                    <a href="javascript:void(0);" class="get-verify-code">获取验证码</a>
                </p>
                ...
                <p>
                    ...
                    <input type="text" name="invitation-code" id="invitation-code" placeholder="选填"/>
                </p>
            </div>
    ...
    $(function () {
        ...
        $('.get-verify-code').on('click', function () {
            ...
            if (isEmpty('#phone-num')) {
                ...
                sendRequest("getRegisterVerifyCode.htm?phoneNumber="+phone, "GET", function (msg) {
                    if(msg) {
        ...
        $('.btn-done-register').on('click', function () {
            ...
            if (password.length < 6 || password.length > 20) {
                ...
                var inviteCode = trim($('#invitation-code').val());
                var data = {"phoneNumber":phoneNumber, "password":hex_md5(password), "inviteCode":inviteCode};
                sendRequest("register.htm", "POST", data, function (msg) {
                    if(msg) {
                        layer.alert(msg, {
                            title: false,
                            closeBtn: false
                        ...
                        layer.alert('注册成功!需先完善个人信息,才能接受订单预约!', {
                            title: false,
                            closeBtn: false,
                            btn: '我知道了'
                        }, function () {
