...
<div id="mainDiv">
  ...
  <ul class="moneyul">
    ...
    <%
      if(order.getStatus().equals(OrderStatus.NO_COMMENT.getValue())) {
    %>
    ...
    %>
      <li>
        <span class="moneyultitle_sp3">保证金返回：</span>
        <span class="moneyulcont_sp3">-<%=order.getDeposit()%>元<font style="color:#DF0101;">(已返回)</font></span>
      </li>
      <li class="moneyul_li4">
        <span class="moneyultitle_sp4">实付：</span>
