...
<head>
  ...
  <style>
    ...
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li2{width:100%;padding:1.6em 0 1.6em 0;float:left;border-bottom:#F1F1F1 0.13em solid;-webkit-border-bottom:#F1F1F1 0.13em solid;}
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li2 p{width:94%;padding:0.2em 0 0.2em 0;margin-left:3%;font-size:1.55em;}
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li3{width:100%;padding:1.5em 0 1.5em 0;border-bottom:#F1F1F1 0.13em solid;-webkit-border-bottom:#F1F1F1 0.13em solid;float:left;}
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li3 .btmul_li_ul_li3_sp1{font-size:1.5em;margin-left:3%;float:left;}
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li3 .btmul_li_ul_li3_sp2{font-size:1.5em;margin-right:3%;float:right;color:#FB9D3B;}
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li3 .btmul_li_ul_li3_sp3{font-size:1.5em;margin-right:3%;float:right;color:#FB9D3B;}
...
<div id="mainDiv">
  ...
  <ul class="btmul">
    ...
    %>
          <li class="btmul_li" onClick="toNoPayDetail('<%=order.getOrderNumber()%>');">
    ...
    %>
          <li class="btmul_li" onClick="toNoTreatDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2">待就诊</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
    ...
    %>
          <li class="btmul_li" onClick="toNoCommentDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2">待评价</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
              ...
              <li class="btmul_li_ul_li3">
                <span class="btmul_li_ul_li3_sp1">实付：<font style="color:#FB9D3B;"><%=order.getTotalFee()%>元</font></span>
                <span class="btmul_li_ul_li3_sp2">评价 (<font style="color:#000000;">3天16时6分</font>)</span>
                <span class="btmul_li_ul_li3_sp3">再次预约</span>
              </li>
            </ul>
          </li>
    <%
    ...
    %>
          <li class="btmul_li" onClick="toNoShareDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2">待分享</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
              ...
              <li class="btmul_li_ul_li3">
                <span class="btmul_li_ul_li3_sp1">实付：<font style="color:#FB9D3B;"><%=order.getTotalFee().subtract(order.getDeposit())%>元</font></span>
                <span class="btmul_li_ul_li3_sp2">评价 (<font style="color:#000000;"><%=WechatUtils.shareTimeLevel(order.getUpdateDate())%></font>)</span>
                <span class="btmul_li_ul_li3_sp3">再次预约</span>
              </li>
            </ul>
          </li>
    <%
        } else if(order.getStatus().equals(OrderStatus.FINISHED.getValue())){
    %>
          <li class="btmul_li" onClick="toFinishedDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2" style="color: #2882D8;">已完成</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
    ...
    <%
        } else if(order.getStatus().equals(OrderStatus.NO_COMMENT.getValue())){
    %>
          <li class="btmul_li" onClick="toFinishedDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2" style="color: #2882D8;">已完成(无评论)</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
    ...
    <%
        } else if(order.getStatus().equals(OrderStatus.NO_SHARE.getValue())){
    %>
          <li class="btmul_li" onClick="toFinishedDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2" style="color: #2882D8;">已完成(无分享)</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
    ...
    <%
        }else if(order.getStatus().equals(OrderStatus.NO_DIAGNOSE.getValue()) 
        		|| order.getStatus().equals(OrderStatus.PATIENT_MISS.getValue())){
    %>
          <li class="btmul_li" onClick="toNoDiagnoseDetail('<%=order.getOrderNumber()%>');">
            <ul class="btmul_li_ul">
              <li class="btmul_li_ul_li1">
                <span class="btmul_li_ul_li1_sp1">预约号：<font style="color:#A4A4A4;"><%=order.getOrderNumber()%></font></span>
                <span class="btmul_li_ul_li1_sp2" style="color: #2882D8;">未就诊</span>
              </li>
              <li class="btmul_li_ul_li2">
                <p class="btmul_li_ul_li2_p1">预约医生：<font style="color:#A4A4A4;"><%=order.getDoctor()%></font></p>
                <p class="btmul_li_ul_li2_p2">预约时间：<font style="color:#A4A4A4;"><%=DateUtils.format(order.getAppointmentTime(), "yyyy-MM-dd HH:mm")%>&nbsp;&nbsp;<%=DateUtils.getWeekOfDate(order.getAppointmentTime())%></font></p>
...
<script>
  ...
  function toNoPayDetail(orderNumber) {
    window.location.href = 'toNoPayDetail.htm?orderNumber='+orderNumber;
  }
  function toNoTreatDetail(orderNumber) {
    window.location.href = 'toNoTreatDetail.htm?orderNumber='+orderNumber;
  }
  function toNoCommentDetail(orderNumber) {
    window.location.href = 'toNoCommentDetail.htm?orderNumber='+orderNumber;
  }
  function toNoShareDetail(orderNumber) {
    window.location.href = 'toNoShareDetail.htm?orderNumber='+orderNumber;
  }
  function toFinishedDetail(orderNumber) {
    window.location.href = 'toFinishedDetail.htm?orderNumber='+orderNumber;
  }
  function toNoDiagnoseDetail(orderNumber) {
    window.location.href = 'toNoDiagnoseDetail.htm?orderNumber='+orderNumber;
  }
</script>
