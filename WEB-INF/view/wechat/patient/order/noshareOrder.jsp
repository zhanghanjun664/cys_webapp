      ...
      <li class="btmul_li" onClick="jump('<%=order.getOrderNumber()%>');">
        <ul class="btmul_li_ul">
          ...
          <li class="btmul_li_ul_li3">
            ...
            <span class="btmul_li_ul_li3_sp2" onClick="jump(123);">分享 (<font style="color:#000000;"><%=WechatUtils.shareTimeLevel(order.getUpdateDate())%></font>)</span>
            <span class="btmul_li_ul_li3_sp3" onClick="jump(123);">再次预约</span>
          </li>
        </ul>
      </li>
    <%
