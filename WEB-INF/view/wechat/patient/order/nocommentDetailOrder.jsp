...
<head>
    ...
    <style>
        ...
        #mainDiv .showtimeul li .showtimeul_li_sp1 {
            font-size: 1.6em;
            color: #000000;
        }

        #mainDiv .showtimeul li .showtimeul_li_sp2 {
            font-size: 1.6em;
            color: #2882D8;
        }

        #mainDiv .shownumberul {
            width: 100%;
            overflow: hidden;
            padding: 0 0 0.06em 0;
            background: #F2F2F2;
            border-top: #F0F0F0 0.19em solid;
            border-bottom: #F0F0F0 0.18em solid;
        }

        #mainDiv .shownumberul li {
            width: 100%;
            float: left;
            background: #FFFFFF;
            padding: 1.5em 0 1em 0;
        ...
        #mainDiv .shownumberul li .shownumberul_li_sp1 {
            float: left;
            margin-left: 2%;
            font-size: 1.6em;
            color: #000000;
        ...
        #mainDiv .shownumberul li .shownumberul_li_sp2 {
            float: left;
            font-size: 1.6em;
            color: #BDBDBD;
        }

        #mainDiv .shownumberul li .shownumberul_li_sp3 {
            margin-right: 2%;
            float: right;
            font-size: 1.6em;
            color: #DF0101;
        ...
        #mainDiv .dateul {
            ...
            background: #FFFFFF;
            border-top: #F0F0F0 0.125em solid;
        }
        ...
        #mainDiv .dateul li .cont_sp0 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .dateul li .title_sp1 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .dateul li .cont_sp1 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .dateul li .title_sp2 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .orderul li .orderultitle_sp0 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .orderul li .orderulcont_sp0 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .orderul li .orderultitle_sp1 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .orderul li .orderulcont_sp1 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .orderul li .orderultitle_sp2 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .orderul li .orderulcont_sp2 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .orderul li .orderultitle_sp3 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .orderul li .orderulcont_sp3 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }
        ...
        #mainDiv .moneyul {
            ...
            background: #FFFFFF;
            border-top: #F0F0F0 0.1em solid;
            border-bottom: #F0F0F0 0.1em solid;
        }
        ...
        #mainDiv .moneyul li .moneyultitle_sp0 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .moneyul li .moneyulcont_sp0 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .moneyul li .moneyultitle_sp1 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .moneyul li .moneyulcont_sp1 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .moneyul li .moneyultitle_sp2 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .moneyul li .moneyulcont_sp2 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .moneyul li .moneyultitle_sp3 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .moneyul li .moneyulcont_sp3 {
            font-size: 1.55em;
            color: #A4A4A4;
            float: left;
        }

        #mainDiv .moneyul li .moneyultitle_sp4 {
            margin-left: 2%;
            font-size: 1.55em;
            color: #000000;
            float: left;
        ...
        #mainDiv .moneyul li .moneyulcont_sp4 {
            font-size: 1.55em;
            color: #FB9D3B;
            float: left;
        }

        #mainDiv .moneyul li:nth-child(4) {
            margin-bottom: 0.5em;
        }

        #mainDiv .moneyul .moneyul_li4 {
            padding: 1.2em 0 1.2em 0;
            border-top: #F0F0F0 0.12em solid;
            border-bottom: #F0F0F0 0.12em solid;
        }
        ...
        #mainDiv .btnul li:nth-child(1) {
            width: 43%;
            float: left;
            margin-left: 3%;
        }

        #mainDiv .btnul li:nth-child(2) {
            width: 43%;
            float: right;
            margin-right: 3%;
            background: #2882D8;
...
<div id="mainDiv">
    ...
    <ul class="shownumberul">
        <li><span class="shownumberul_li_sp1">订单编号：</span><span class="shownumberul_li_sp2"><%=order.getOrderNumber()%></span><span
                class="shownumberul_li_sp3">待评价</span></li>
    </ul>
    <ul class="orderul">
        <li>
...
<script>
    ...
    function tocomment() {
        window.location.href = 'tonocommentDetailOrder.htm?orderNumber=<%=order.getOrderNumber()%>';
    }
