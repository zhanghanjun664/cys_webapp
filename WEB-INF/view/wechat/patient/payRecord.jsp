...
<%
  List<PatientPaymentHistoryQueryModel> patientPaymentHistoryQueryModelList=(List<PatientPaymentHistoryQueryModel>)request.getAttribute("patientPaymentHistoryQueryModelList");
%>
<!DOCTYPE html>
<html>
<head>
...
<div id="mainDiv">
  ...
  <ul class="btmul">
    <%
      if(patientPaymentHistoryQueryModelList!=null){
        for(int i=0;i<patientPaymentHistoryQueryModelList.size();i++){
          PatientPaymentHistoryQueryModel patientPaymentHistoryQueryModel=patientPaymentHistoryQueryModelList.get(i);
          String paymentType = patientPaymentHistoryQueryModel.getType();
          if(paymentType.equals(PatientPaymentHistoryType.WITHDRAW.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">提现(<%=PaymentStatus.getDescription(patientPaymentHistoryQueryModel.getStatus())%>)</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">-<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
        </li>
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.REFUND.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">患者取消订单退款</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.SERVICE_REFUND.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">咨询服务退款</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.QRCODE_REWARD.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">注册奖励</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.RECOMMEND.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1"><%=patientPaymentHistoryQueryModel.getDescription()%></p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.BE_INVITED.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
    ...
    <%
          }else if(paymentType.equals(PatientPaymentHistoryType.DOCTOR_CANCEL.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">医生取消订单退款</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.WX_CHARGE.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">微信充值</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.ALIPAY_CHARGE.getValue())) {
        	    %>
                <li class="btmul_li">
                  <ul>
                    <li class="cont_li">
                      <p class="cont_li_p1">支付宝充值</p>
                      <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
                    </li>
                    <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
                  </ul>
            ...
            <%
          } else if(paymentType.equals(PatientPaymentHistoryType.PAY_BOND.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">支付保证金费用</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">-<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.PAY_ORDER.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">支付订单费用</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">-<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.RETURN_BOND.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">评论订单返回保证金</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
    ...
    <%
          } else if(paymentType.equals(PatientPaymentHistoryType.RED_ENVELOPE.getValue())) {
    %>
        <li class="btmul_li">
          <ul>
            <li class="cont_li">
              <p class="cont_li_p1">分享订单红包</p>
              <p class="cont_li_p2"><%=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(patientPaymentHistoryQueryModel.getCreateDate())%></p>
            </li>
            <li class="title_li">+<%=patientPaymentHistoryQueryModel.getAmount()%>元</li>
          </ul>
