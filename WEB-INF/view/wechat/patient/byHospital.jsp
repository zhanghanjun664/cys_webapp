...
<head>
    ...
    <style>
        ...
        #mainDiv .top_ul li:nth-child(3){width:23%;height:100%;}
        ...
        #mainDiv .btmul .btmul_li .btmul_li_p1{width:94%;margin-left:3%;margin-bottom:0.3em;font-size:1.6em;color:#585858;}
        #mainDiv .btmul .btmul_li .btmul_li_p2{width:94%;margin-left:3%;font-size:1.5em;color:#A4A4A4;}
    ...
    <ul class="btmul">
        <%
            for(int i=0;i<hospitalQueryModelList.size();i++){
                JdHospitalQueryModel hospitalQueryModel=hospitalQueryModelList.get(i);
        %>
        <li class="btmul_li" onClick="jump('<%=hospitalQueryModel.getUuid()%>','<%=hospitalQueryModel.getName()%>');">
            <p class="btmul_li_p1"><%=hospitalQueryModel.getName()%></p>
            <p class="btmul_li_p2"><%=hospitalQueryModel.getAddress()%></p>
        </li>
        <%
            }
        %>
