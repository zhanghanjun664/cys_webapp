...
<head>
  ...
  <style>
    ...
    #mainDiv .btmul .btmul_li{width:100%;float:left;margin-bottom:0.1em;border-bottom:#F2F2F2 0.12em solid;-webkit-border-bottom:#F2F2F2 0.12em solid;padding:1.65em 0 1.65em 0;background:#FFFFFF;}
    #mainDiv .btmul .btmul_li .btmul_li_p1{width:94%;margin-left:3%;font-size:1.6em;color:#585858;}
...
<div id="mainDiv">
  ...
  <ul class="btmul">
    <%
      List<String> times = WechatUtils.getBytimeList(true);
      for(int i=0; i < times.size(); i++) {
    %>
      <li class="btmul_li" onClick="jump(<%=i%>,'<%=times.get(i)%>');">
        <p class="btmul_li_p1"><%=times.get(i)%></p>
      </li>
    <%
      }
    %>
