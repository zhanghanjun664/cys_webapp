...
<div id="mainDiv">
    ...
    <ul class="cont_ul">
        <li><input type="text" id="phone" placeholder="请输入手机号码" Maxlength="11"/>
            ...
            <div class="getCodeDiv" onClick="GetCodeOpt.getCode();">获取验证码</div>
        </li>
        <li><input type="text" id="code" placeholder="请输入验证码"/></li>
        <li onClick="GetCodeOpt.checkCode();">下一步</li>
    </ul>
</div>
<div id="MsgBoxDiv">
    <ul>
...
<script>
    ...
    var GetCodeOpt = {
        ...
        getCode: function () {
            ...
            if (GetCodeOpt.checkphone(phone)) {
                var msg = '手机号码格式错误';
                var btnword = '确定';
                MsgOpt.showMsgBox(msg, btnword);
                mythis.codeflag = false;
            ...
            changeCodeBtn();
            var url = 'getForgetVerifyCode.htm?phoneNumber=' + phone;
            $.ajax({
                type: 'GET',
                url: url,
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg) {
                        ...
                        window.location.href = "toForget2.htm?phoneNumber="+phone;
                    }
                },
                timeout: 10000,
                error: function () {
