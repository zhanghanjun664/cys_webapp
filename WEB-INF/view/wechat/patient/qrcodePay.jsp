...
<head>
  ...
  <style>
    ...
    #mainDiv div{text-align:center;font-size: 2em;padding-top: 40px;}
...
<div id="mainDiv">
  ...
  <div><font font-size="2em">长按图片识别二维码进行支付</font></div>
...
<script>
  ...
  function checkPay(){
    setInterval(function(){
      $.ajax({
        type:'GET',
        url:'checkQrcodePay.htm?orderId=<%=orderId%>',
        success:function(result){
          if(result) {
            window.location.href = "wechatOrderok.htm?orderId=<%=orderId%>";
          }
        },
        timeout: 10000,
        error:function(){
