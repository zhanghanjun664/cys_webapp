...
<div id="mainDiv">
  ...
  <ul class="cont_ul">
    <li>可提现金额：<span id="moneysp"><%=doctorModel.getAccountBalance()%></span></li>
    <li><input type="text" id="money" placeholder="输入提现的金额(500的倍数)" /></li>
    ...
    $.ajax({
      ...
      success: function (msg) {
        if (msg.result==0) {
          ...
          MsgOpt.showMsgBox("提现成功", "确定", "mymoney.htm");
