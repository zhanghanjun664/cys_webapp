...
<head>
  ...
  <style>
    ...
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li5 .btmul_li_ul_li5_p1{width:94%;padding:0.2em 0 0.2em 0;margin-left:3%;color:#858585;font-size:1.5em;}
    #mainDiv .btmul .btmul_li ul .btmul_li_ul_li5 .btmul_li_ul_li5_p2{width:94%;padding:0.2em 0 0.2em 0;margin-left:3%;color:#858585;font-size:1.5em;}
    ...
    <li class="btmul_li">
      <ul class="btmul_li_ul">
        ...
        <li class="btmul_li_ul_li5">
          <p class="btmul_li_ul_li5_p2">预约号：<%=orderModel.getOrderNumber()%></p>
        </li>
      </ul>
    </li>
  </ul>
