...
// */
//'use strict';
//app.controller('AddTimeCtrl', function ($scope, $http, $modal, ngTableParams, toaster, SweetAlert) {
...
//          if(jdTitle) {
//              $http.put(REST_PREFIX+"testTest", $scope.payment).success(function(result) {
//                  if (!result) {
